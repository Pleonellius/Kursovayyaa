...
namespace Kursovayyaa
{
    public partial class Form6 : MetroFramework.Forms.MetroForm
    {
        ...
        public void GetListUsers()
        {
            ...
            string commandStr = "SELECT id AS 'Номер' , NamePaci AS 'Ф.И.О Пациента', idVraha AS 'Ф.И.О Врача', Data AS 'Дата', Time AS 'Время', Kab AS 'Кабинет',telf AS 'Номер телефона', vrahtelf AS 'Номер тел. врача' FROM Taloni";
